...
export const tipsAndAdvices = [
  {
    ...
    advices: [
      ...
      "Vêtements légers: Porte des vêtements légers et amples pour permettre à ton corps de mieux réguler sa température.",
  ...
  },
  {
    ...
    marge: 'Symptoms',
    details: 'La pandémie de Covid-19 a eu un impact significatif sur le monde entier, bouleversant nos vies quotidiennes et mettant en évidence l\'importance de la santé publique et de la solidarité mondiale. Cette crise sanitaire a mis en lumière la nécessité de mesures préventives telles que le lavage fréquent des mains, le port de masques faciaux et la distanciation sociale pour limiter la propagation du virus. Alors que la vaccination progresse et que des efforts sont déployés pour contenir la pandémie, il est essentiel de rester vigilants et de continuer à suivre les directives des autorités sanitaires pour protéger la santé de chacun. En travaillant ensemble, en restant solidaires et en adoptant des pratiques sécuritaires, nous pouvons surmonter cette crise et envisager un avenir plus sain et plus résilient.',
    advices: ['Suivre les directives des autorités sanitaires: Restez informé des recommandations et des directives émises par les autorités sanitaires locales et nationales. Cela comprend le port de masques faciaux, la pratique de la distanciation sociale et le respect des règles de confinement ou de quarantaine si elles sont en place.',
  ...
  },
  {
    poster: [
      ...
      require('../assets/images/tete1.png'),
      require('../assets/images/tet2.jpg'),
